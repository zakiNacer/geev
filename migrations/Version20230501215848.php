 ...
 */
final class Version20230501215848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit_collecte DROP quantity');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit_collecte ADD quantity INT NOT NULL');
    }
}
